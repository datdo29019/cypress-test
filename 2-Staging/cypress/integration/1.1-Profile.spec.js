...
cy.wait(1000)
cy.contains('English').should('have.contain','English')
cy.wait(1000)
cy.contains('Tiếng Việt').should('have.contain','Tiếng Việt')
cy.wait(1000)
cy.contains('English',{ timeout: 10000 },{ force: true }).click()
  ...
  cy.get(':nth-child(2) > .js-is-select',{ timeout: 10000 }).click()
  cy.contains('English',{ timeout: 10000 },{ force: true }).should('be.visible')
